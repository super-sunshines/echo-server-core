...
func newSysMenu(db *gorm.DB, opts ...gen.DOOption) sysMenu {
	...
	_sysMenu.APICode = field.NewString(tableName, "api_code")
	_sysMenu.APIDescription = field.NewString(tableName, "api_description")
	_sysMenu.MetaID = field.NewInt64(tableName, "meta_id")
...
type sysMenu struct {
	...
	ID             field.Int64  // id
	Pid            field.Int64  // 父目录
	Type           field.Int64  // 目录类型 0:目录 1:接口
	APICode        field.String // 接口代码
	APIDescription field.String // 接口描述
	MetaID         field.Int64  // metaID
...
func (s *sysMenu) updateTableName(table string) *sysMenu {
	...
	s.APIDescription = field.NewString(table, "api_description")
	s.MetaID = field.NewInt64(table, "meta_id")
...
func (s *sysMenu) fillFieldMap() {
	...
	s.fieldMap["api_description"] = s.APIDescription
	s.fieldMap["meta_id"] = s.MetaID
