...
func newSysUser(db *gorm.DB, opts ...gen.DOOption) sysUser {
	...
	_sysUser.RoleCodeList = field.NewField(tableName, "role_code_list")
...
func (s *sysUser) updateTableName(table string) *sysUser {
	...
	s.RoleCodeList = field.NewField(table, "role_code_list")
...
func (s *sysUser) fillFieldMap() {
	...
	s.fieldMap["role_code_list"] = s.RoleCodeList
